 ...
 *
 */
public class ExampleSimpleCompiler implements JavaCompiler{
    ...
    public ExampleSimpleCompiler(){
        this(ToolProvider.getSystemJavaCompiler(), Thread.currentThread().getContextClassLoader());
    }
    
    public ExampleSimpleCompiler(JavaCompiler compiler, ClassLoader classLoader){
