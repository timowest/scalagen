 ...
 *
 */
public class ExampleSourceFileObject extends SimpleJavaFileObject {
    ...
    public ExampleSourceFileObject(String fullName) {
        super(toUri(fullName),JavaFileObject.Kind.SOURCE);
        contents = new StringBuilder(1000);
    }
    
    public ExampleSourceFileObject(String fullName, String content) {
        this(fullName);
