 ...
 * @param <T>
 */
public abstract class ExampleAbstractCodeWriter<T extends ExampleAbstractCodeWriter<T>> implements Appendable {
    ...
    public ExampleAbstractCodeWriter(Appendable appendable, int spaces){
        if (appendable == null){
