 ...
 *
 */
public final class ExampleFileSystemRegistry {
    
    public static final ExampleFileSystemRegistry DEFAULT = new ExampleFileSystemRegistry();
    ...
    private ExampleFileSystemRegistry() {
        String pkgName = ExampleFileSystemRegistry.class.getPackage().getName();
